...
if 'PAGE' not in streamlit.session_state:
    streamlit.session_state['PAGE'] = 'PAGE_06'
else:
    if streamlit.session_state['PAGE'] != 'PAGE_06':
        streamlit.session_state.clear()
    else:
        pass

streamlit.write('## Bülten Veri Tabanı Excel Aktarma Ekranı ##')
...
if streamlit.session_state.button_export:
    ...
    query = "SELECT * FROM bulletin_bet_data;"  # Replace 'your_table' with your table name
    ...
    excel_file_path = 'Output/Bülten_Veritabanı.xlsx'  # Replace with your desired Excel file path
